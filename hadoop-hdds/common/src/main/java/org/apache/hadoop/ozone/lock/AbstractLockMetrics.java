...
/**
 * Base class for maintaining the various generic lock metrics.
 */
@InterfaceAudience.Private
@Metrics(about = "Generic Lock Metrics", context = OzoneConsts.OZONE)
public abstract class AbstractLockMetrics implements MetricsSource {
  ...
  protected AbstractLockMetrics(MetricsRegistry registry) {
  ...
  protected void getMetrics(MetricsCollector collector, boolean all, String name) {

...
public final class OzoneManagerRatisServer {
  ...
  private static void setRaftRpcProperties(RaftProperties properties, ConfigurationSource conf) {
    // Set Read option
    RaftServerConfigKeys.Read.setOption(properties, conf.getEnum(
        OMConfigKeys.OZONE_OM_RATIS_SERVER_READ_OPTION,
        OMConfigKeys.OZONE_OM_RATIS_SERVER_READ_OPTION_DEFAULT));
    RaftServerConfigKeys.Read.setLeaderLeaseEnabled(properties, conf.getBoolean(
        OMConfigKeys.OZONE_OM_RATIS_SERVER_READ_LEADER_LEASE_ENABLED,
